...
function createProvider(networkName, networkConfig, paths, artifacts, experimentalHardhatNetworkMessageTraceHooks = []) {
    ...
    if (networkName === constants_1.HARDHAT_NETWORK_NAME) {
        ...
        hardhatNetConfig.mining.mempool.order, new logger_1.ModulesLogger(hardhatNetConfig.loggingEnabled), accounts, artifacts, hardhatNetConfig.allowUnlimitedContractSize, hardhatNetConfig.initialDate !== undefined
            ? date_1.parseDateString(hardhatNetConfig.initialDate)
            : undefined, experimentalHardhatNetworkMessageTraceHooks, forkConfig, paths !== undefined ? disk_cache_1.getForkCacheDirPath(paths) : undefined, hardhatNetConfig.coinbase);
    }
    else {
