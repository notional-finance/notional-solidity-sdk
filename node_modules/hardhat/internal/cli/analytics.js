...
const log = debug_1.default("hardhat:core:analytics");
...
class Analytics {
    constructor({ clientId, telemetryConsent, userType, }) {
        ...
        this._enabled =
            !execution_mode_1.isLocalDev() && !ci_detection_1.isRunningOnCiServer() && telemetryConsent === true;
...
async function getClientId() {
    ...
    if (clientId === undefined) {
        clientId = (_a = (await global_dir_1.readSecondLegacyAnalyticsId())) !== null && _a !== void 0 ? _a : (await global_dir_1.readFirstLegacyAnalyticsId());
        if (clientId === undefined) {
