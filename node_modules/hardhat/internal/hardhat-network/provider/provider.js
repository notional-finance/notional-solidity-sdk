...
class HardhatNetworkProvider extends events_1.EventEmitter {
    constructor(_hardfork, _networkName, _chainId, _networkId, _blockGasLimit, _initialBaseFeePerGas, _minGasPrice, _throwOnTransactionFailures, _throwOnCallFailures, _automine, _intervalMining, _mempoolOrder, _logger, _genesisAccounts = [], _artifacts, _allowUnlimitedContractSize = false, _initialDate, _experimentalHardhatNetworkMessageTraceHooks = [], _forkConfig, _forkCachePath, _coinbase = exports.DEFAULT_COINBASE) {
        super();
