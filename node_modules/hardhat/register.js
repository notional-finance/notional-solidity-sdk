...
const antlr_prototype_pollution_workaround_1 = require("./internal/util/antlr-prototype-pollution-workaround");
...
if (!context_1.HardhatContext.isCreated()) {
    ...
    if (typescript_support_1.willRunWithTypescript(hardhatArguments.config)) {
        typescript_support_1.loadTsNode(hardhatArguments.tsconfig);
    }
